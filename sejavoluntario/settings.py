# Django settings for sejavoluntario project.
...
DATABASES = {
    'default': {# 
        ...
        'NAME': 'sejavoluntario',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '4e*jmdmr+o0h)vw&#9__m6opk)cdtdp3!#py32bvdb$d$0%=7x'
...
ROOT_URLCONF = 'sejavoluntario.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sejavoluntario.wsgi.application'
