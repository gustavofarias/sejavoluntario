...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Endereco.cep'
        db.add_column('users_endereco', 'cep',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=6),
                      keep_default=False)


        # Changing field 'Endereco.logradouro'
        db.alter_column('users_endereco', 'logradouro', self.gf('django.db.models.fields.TextField')(default='logradouro', max_length=255))

    def backwards(self, orm):
        # Deleting field 'Endereco.cep'
        db.delete_column('users_endereco', 'cep')


        # Changing field 'Endereco.logradouro'
        db.alter_column('users_endereco', 'logradouro', self.gf('django.db.models.fields.TextField')(null=True))
