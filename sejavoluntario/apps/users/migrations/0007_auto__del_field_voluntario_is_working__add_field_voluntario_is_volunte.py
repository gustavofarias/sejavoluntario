...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Voluntario.is_working'
        db.delete_column('users_voluntario', 'is_working')

        # Adding field 'Voluntario.is_volunteer'
        db.add_column('users_voluntario', 'is_volunteer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Voluntario.is_volunteering_at'
        db.add_column('users_voluntario', 'is_volunteering_at',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=False, to=orm['users.Beneficiario'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Voluntario.is_working'
        db.add_column('users_voluntario', 'is_working',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Voluntario.is_volunteer'
        db.delete_column('users_voluntario', 'is_volunteer')

        # Deleting field 'Voluntario.is_volunteering_at'
        db.delete_column('users_voluntario', 'is_volunteering_at_id')
