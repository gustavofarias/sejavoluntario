...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Beneficiario.banco'
        db.alter_column('users_beneficiario', 'banco_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.DadosBancarios'], null=True))

    def backwards(self, orm):

        # Changing field 'Beneficiario.banco'
        db.alter_column('users_beneficiario', 'banco_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.DadosBancarios']))
